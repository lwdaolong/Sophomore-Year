...
public:
    ...
    void setCol(int a);
    void incrementCurrColRight();
    void decrementCurrColLeft();
    void setRow(int a);
    void incrementRow();
    void decrementRow();
    void insertChar(int line, int col, char a);
    void deleteCharatcol(int line, int col);
    void setCursor(int x, int y);
    void createNewLine();
    void undoNewLine(int r, int c);
    void moveCursorUp();
    void moveCursorDown();
    void deletLine( bool& b);
    void setLine(int a,std::string s);
    void refillFirstLine(std::string s);
    void backspaceinline(int x, int y);
    void backspacedeleteline(int x, int y);
...
private:
    ...
    int linecount;
    std::string errormsg;
    std::vector<std::string> textbeingeditted;
