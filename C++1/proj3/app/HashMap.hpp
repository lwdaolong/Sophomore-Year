...
public:
    ...
    static constexpr double MAX_LOAD_FACTOR = .8;
...
public:
    ...
    bool addBool(const std::string& key, const std::string& value);
    ...
    bool containsKV(const std::string& key, const std::string& value) const;
    ...
    HashLinkedList* getLinkedList() const; // used in copy assignment
...
private:
    ...
    */
    ...
    unsigned int currsize; //num elements within hash table
    unsigned int bucketcount; //num of buckets
    HashLinkedList* l; //pointer to an array of linked lists
    ...
    void resize(); //takes a static constant laodfactor to check if it should resize or not
